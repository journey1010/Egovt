...
<main>
    <div class="mt-4 p-4">
        <h1 class="text-monospace ml-3" style="font-size: 40px">Publicaciones</h1>
    </div>
    <article class="dsSingleContent pt-4 pb-2 pt-md-7 pb-md-1 pt-lg-4 pb-lg-10 pt-xl-3 pb-xl-16 bg-white">
        <div class="container saldo-container">
            ...
            <section class="ItemfullBlock pb-md-9 pb-lg-13 pb-xl-19">
                <div class="container">
                    <!-- <div class="pt-3 pb-3 pt-lg-3 pb-lg-9 pt-xl-7 pb-xl-12 publicaciones">
                        <?php
                                ...
                                <div class="d-lg-flex align-items-md-center">
                                    ...
                                    <div class="d-md-flex align-items-md-center flex-grow-1">
                                        ...
                                        <div class="descrWrap flex-grow-1">
                                            <strong class="tagTitle d-block text-secondary fwSemiBold mb-2"><?= $data['type_doc'] ?></strong>
                                            <h3 class="fwMedium">
                                                <p><?= $data['title']; ?></p>
                                            </h3>
                                            <h5 class="fwMedium">
                                    ...
                                    <div class="descrWrap mt-3">
                                        ...
                                        <div class="row row-cols-3 p-3">
                                            <?php foreach ($files as $file) : ?>
                                                <a href="<?= _BASE_URL ?>/files/publicaciones/<?= $partialPath . $file['file'] ?>" class=""><?= $file['namefile'] ?></a>
                                            <?php endforeach; ?>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="publicaciones-container row">
                        <div class="col-lg-12 col-xl-12 col-md-12 order-lg-2 mb-6">
                        <div class="card-columns mt-2 publicaciones-card col-12">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <div class="descrWrap">
                                                ...
                                                <p class="d-block fileSize text-dark card-text mb-3"><?= $fecha ?></p>
                                                <p class="text-dark fileSize card-tile mb-2"><span class="badge badge-dark text-wrap"><?= $row['type_doc'] ?></span></p>
            ...
            <div class="paginador-publicaiones">
                <?= $Paginador ?>
            </div>
        </div>
    </article>
