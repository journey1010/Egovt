						...
						<div class="container">
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Events Grid with Sidebar</li>
								</ol>
							</nav>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12 col-lg-9 mb-6">
							<div class="pr-lg-5 pr-xl-15">
								<header class="ifbFilterHead ifbFilterHeadAlter bg-light px-4 pt-4 pb-3 px-lg-8 pt-lg-7 pb-lg-6">
									<div class="form-row mx-n3 align-items-end">
										...
										<button type="button" class="btn btnTheme ml-lg-3 mt-4 mt-lg-0 ml-auto mr-auto mr-lg-0 font-weight-bold text-capitalize position-relative border-0 p-0" data-hover="Find Events">
											<span class="d-block btnText">Find Events</span>
										</button>
									</div>
								</header>
								<ul class="list-unstyled ifbFiltersList d-flex isoFiltersList mt-5 mb-8 mt-lg-8 mb-lg-12 fontAlter flex-wrap">
									<li class="active">
										<a href="javascript:void(0);">All</a>
									</li>
									<li>
										<a href="javascript:void(0);" data-filter=".conference">Conference</a>
									</li>
									<li>
										<a href="javascript:void(0);" data-filter=".entertainement">Entertainement</a>
									</li>
									<li>
										<a href="javascript:void(0);" data-filter=".heaspo">Health &amp; Sport</a>
									</li>
									<li>
										<a href="javascript:void(0);" data-filter=".meeting">Meeting</a>
									</li>
									<li>
										<a href="javascript:void(0);" data-filter=".workshop">Workshop</a>
									</li>
								</ul>
								<div class="row justify-content-center isoContentHolder">
									<div class="col-12 col-md-6 isoCol conference">
									...
									<div class="col-12 col-md-6 isoCol entertainement">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 mb-xl-12 w-100">
											<div class="imgHolder position-relative">
												<a href="javascript:void(0);">
									...
									<div class="col-12 col-md-6 isoCol heaspo">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 mb-xl-12 w-100">
											<div class="imgHolder position-relative">
												<a href="javascript:void(0);">
									...
									<div class="col-12 col-md-6 isoCol meeting">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 mb-xl-12 w-100">
											<div class="imgHolder position-relative">
												<a href="javascript:void(0);">
									...
									<div class="col-12 col-md-6 isoCol workshop">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 mb-xl-12 w-100">
											<div class="imgHolder position-relative">
												<a href="javascript:void(0);">
													<img src="images/img65.jpg" class="img-fluid d-block w-100" alt="image description">
												</a>
												<time class="ueTimeTag position-absolute text-center d-flex bg-white fontAlter fwSemiBold text-lDark text-uppercase" datetime="2011-01-12">
											...
											<div class="ueDescriptionWrap pt-5 pb-8 px-5">
												...
												<h3 class="h3Small fwMedium mb-3">
													<a href="eventSingle.html">City Innovation and Technology Committee Meeting</a>
												</h3>
												<address>
													<ul class="list-unstyled ueScheduleList">
														<li>
									...
									<div class="col-12 col-md-6 isoCol entertainement">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 mb-xl-12 w-100">
											<div class="imgHolder position-relative">
												<a href="javascript:void(0);">
													<img src="images/img66.jpg" class="img-fluid d-block w-100" alt="image description">
												</a>
												<time class="ueTimeTag position-absolute text-center d-flex bg-white fontAlter fwSemiBold text-lDark text-uppercase" datetime="2011-01-12">
											...
											<div class="ueDescriptionWrap pt-5 pb-8 px-5">
												...
												<h3 class="h3Small fwMedium mb-3">
													<a href="eventSingle.html">Faith Forward Future - Social Awareness Seminar</a>
												</h3>
												<address>
													<ul class="list-unstyled ueScheduleList">
														<li>
								...
								<nav aria-label="Page navigation">
									<ul class="pagination justify-content-center pt-2">
										...
										<li class="page-item">
											<a class="page-link" href="javascript:void(0);">Next <i class="fa fa-chevron-right icn"><span class="sr-only">icon</span></i></a>
										</li>
									</ul>
								</nav>
							</div>
