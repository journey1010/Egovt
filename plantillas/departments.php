				...
				<div class="container">
					...
					<div class="row justify-content-center">
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img24.jpg" class="img-fluid w-100" alt="image description">
								...
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
									...
									<a href="departmentsSingle.html" class="btn btn-outline-light btnNoOver d-block w-100 mt-7">Read More <i class="fas btnBnoIcn fa-arrow-right mx-1"><span class="sr-only">icon</span></i></a>
								</div>
							</article>
						</div>
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img25.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico12 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img26.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico13 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img27.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico14 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img28.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico15 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img29.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico16 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img30.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico17 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img31.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico18 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
						...
						<div class="col-12 col-sm-6 col-lg-4 d-sm-flex">
							<article class="egdColumn shadow bg-white position-relative w-100 mb-6 mb-lg-12 text-center mx-auto">
								<div class="imgHolder position-relative mb-5">
									<img src="images/img32.jpg" class="img-fluid w-100" alt="image description">
									<i class="icomoon-ico19 position-absolute icnWrap rounded-circle d-flex align-items-center justify-content-center shadow"><span class="sr-only">icon</span></i>
								</div>
								<div class="egdcCaption py-4 px-3 py-md-8 px-md-6">
