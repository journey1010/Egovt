			...
			<header class="pageMainHead d-flex position-relative bgCover w-100 text-white" style="background-image: url(images/img58.jpg);">
				<div class="alignHolder d-flex w-100 align-items-center">
					<div class="align w-100 position-relative">
						<div class="container">
							<h1 class="text-white mb-2">Business and Industry</h1>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Business and Industry</li>
								</ol>
							</nav>
						</div>
					</div>
						...
						<div class="col-12 col-lg-8 col-xl-9 mb-6">
							<div class="pr-xl-14">
								<header class="fzMedium mb-6">
									<h2 class="fwSemiBold h2vii">Business and Industry</h2>
								...
								<p>It was installed globally, an annual market growth of 22 percent. It is continuing its progress towards becoming a mainstream competitive salary and economy reports by mine.</p>
								<div class="imgCenter mt-6 mb-7 mt-lg-10 mb-lg-11">
									<img src="images/img60.jpg" class="img-fluid w-100" alt="image description">
								</div>
								<h3 class="fwSemiBold mb-4">Inspect and Fill Transmission and Differential:</h3>
								...
								<div class="overflow-hidden mt-6 mb-5 mt-md-9 mb-md-7">
									<div class="imgLeft text-center text-md-left mb-4 mb-md-0 mr-4 mr-md-8 pt-lg-1">
										<img src="images/img61.jpg" class="img-fluid shadow" alt="image description">
									</div>
								...
								<p class="mb-6 mb-md-10">In fact, wind is becoming cheap enough in many places in the U.S. and around the world to compete effectively with fossil fuels. local economy, but manufacturing components locally also helps to eliminate long-distance transport costs, for the large components in particular.</p>
								<h3 class="fwSemiBold">Goverment Business Fecilities:</h3>
								...
								<div class="row mt-8 mt-lg-14 mb-5">
									<div class="col-12 col-md-4">
										<article class="gbfColumn gbfcVII bg-white shadow text-center px-4 pt-2 pb-7 mb-6">
											<i class="icnWrap icomoon-ico12 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
											<h3 class="mb-0 fwMedium h3Small position-relative pb-4">Money and <br>Taxes</h3>
										</article>
									</div>
									<div class="col-12 col-md-4">
										<article class="gbfColumn gbfcVII bg-white shadow text-center px-4 pt-2 pb-7 mb-6">
											<i class="icnWrap icomoon-ico27 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
											<h3 class="mb-0 fwMedium h3Small position-relative pb-4">Application for <br>Licences</h3>
										</article>
									</div>
									<div class="col-12 col-md-4">
										<article class="gbfColumn gbfcVII bg-white shadow text-center px-4 pt-2 pb-7 mb-6">
											<i class="icnWrap icomoon-ico28 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
											<h3 class="mb-0 fwMedium h3Small position-relative pb-4">Housing and <br>Land</h3>
										</article>
									</div>
								</div>
								<h3 class="fwSemiBold mb-4">Business Loans and Interest Rate Info:</h3>
								<p>Thomas Edison may have been behind the invention of the electric light bulb, but he did not work alone. Edison worked alongside partners, both financial and commercial, to get his inventions off the ground.</p>
								...
								<div class="my-6 my-md-9 my-lg-11">
									<ul class="nav nav-tabs dcsTabset fontAlter" id="dcsTab" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" id="identified-tab" data-toggle="tab" href="#identified" role="tab" aria-selected="true">Identified</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" id="consulting-tab" data-toggle="tab" href="#consulting" role="tab" aria-selected="false">Consulting</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" id="produce-tab" data-toggle="tab" href="#produce" role="tab" aria-selected="false">Produce</a>
										</li>
									</ul>
							...
							<aside class="dscSidebar pt-1 ml-xl-n5">
								<nav class="widget mb-6 mb-lg-10 widgetDepartsNav widgetBgLight py-5 px-6">
									...
									<ul class="list-unstyled pl-0 mx-n2 mb-0 mb-3">
										<li>
											<a href="javascript:void(0);">Your Goverment</a>
										</li>
										<li>
											<a href="javascript:void(0);">Jobs and Unemployment</a>
										</li>
										<li class="active">
											<a href="javascript:void(0);">Business and Industry</a>
										</li>
										<li>
											<a href="javascript:void(0);">Roads &amp; Transportation</a>
										</li>
										<li>
											<a href="javascript:void(0);">Culture &amp; Recreation</a>
										</li>
										<li>
											<a href="javascript:void(0);">Justice, Safty and the law</a>
										</li>
										<li>
											<a href="javascript:void(0);">Education and skills</a>
										</li>
										<li>
											<a href="javascript:void(0);">Health and Securities</a>
										</li>
									</ul>
								</nav>
