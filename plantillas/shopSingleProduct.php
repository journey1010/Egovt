...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
			<header class="pageMainHead d-flex position-relative bgCover w-100 text-white" style="background-image: url(images/img104.jpg);">
				<div class="alignHolder d-flex w-100 align-items-center">
					<div class="align w-100 position-relative">
						<div class="container">
							<h1 class="text-white mb-2">Fit Blazer Hoodies</h1>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
									<li class="breadcrumb-item"><a href="home.html">Home</a></li>
									<li class="breadcrumb-item"><a href="shop.html">Shop</a></li>
									<li class="breadcrumb-item active" aria-current="page">Fit Blazer Hoodies</li>
								</ol>
							</nav>
						</div>
					</div>
			...
			<article id="content" class="ItemfullBlock pt-7 pb-7 pt-md-10 pb-md-9 pt-lg-14 pb-lg-13 pt-xl-22 pb-xl-19">
				<div class="container">
					<div class="row">
						<div class="col-12 col-md-4 col-lg-3 mb-6">
							<div class="mr-md-n3 mr-lg-n5">
								<aside class="sidebar">
									<section class="widget widgetSearch mb-6 mb-lg-6">
									...
									<div class="widget widgetPriceFilter mb-6 mb-lg-10">
										...
										<div class="getResultsWrap d-flex align-items-center justify-content-between">
											<button type="button" class="btn btnGreyAlter btn-sm fwMedium text-capitalize position-relative border-0 p-0" data-hover="Filter">
												<span class="d-block btnText">Filter</span>
											</button>
											<p id="amount" class="fwSemiBold mb-0 text-uppercase"></p>
										</div>
									</div>
						...
						<div class="col-12 col-md-8 col-lg-9">
							<div class="pl-md-5 pl-xl-15 fontAlter">
								<div class="row mb-8 mb-xl-12">
									<div class="col-12 col-lg-6">
										<div class="imageWrap mb-5">
											<img src="images/img122.jpg" class="img-fluid w-100" alt="image description">
										</div>
									</div>
									<div class="col-12 col-lg-6">
										<!-- sdbWDescription -->
										<div class="sdbWDescription fontBase">
											<h3 class="fwMedium mb-0">Fit Blazer Hoodies</h3>
											<div class="d-flex align-items-center mb-2">
												<!-- ratingList -->
												<ul class="list-unstyled ratingStarList d-flex mb-0 mr-2">
											...
											<h4 class="fwMedium mb-3">£14.99</h4>
											...
											<a href="javascript:void(0);" class="txtLink fwMedium fontAlter">In stock</a>
											<!-- cartForm -->
											<form action="#" class="cartForm mt-4 mb-6">
												<div class="form-row mx-0">
													...
													<button type="submit" class="mb-2 mb-sm-0 btn btnTheme d-flex fwMedium text-uppercase position-relative border-0 p-0" data-hover="Add to Cart">
													   <span class="d-block btnText">Add to Cart</span>
													</button>
												</div>
											</form>
											<!-- shpDefinaition -->
											<dl class="shpDefinaition text-capitalize fsBody2">
												<dt class="fwNormal">Tags: </dt>
												<dd>Woo, Fit</dd>
												<dt class="fwNormal">Category: </dt>
												<dd>Clothings, Hoodies</dd>
											</dl>
										</div>
									</div>
								</div>
									...
									<div class="tab-pane fade show active" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
										<div class="overflow-hidden px-3 px-md-6 pt-5 pb-1">
											...
											<form action="#" class="reviewSubmissionForm pb-3">
												<h4 class="fwMedium mb-2">Add a Review</h4>
												<p class="mb-6">Your email address will not be published. Required fields are marked <em class="req">*</em></p>
												<div class="form-group row">
													<label class="col-sm-3 col-xl-2 col-form-label">Name  <em class="req">*</em></label>
												...
												<div class="form-group row">
													<div class="col-sm-8 offset-sm-2">
														<button type="submit" class="btn btnTheme d-flex font-weight-bold text-capitalize position-relative border-0 p-0" data-hover="Submit">
								...
								<h3 class="fwMedium mb-5">Related Product</h3>
								<div class="row">
