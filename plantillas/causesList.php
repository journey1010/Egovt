			...
			<header class="pageMainHead d-flex position-relative bgCover w-100 text-white" style="background-image: url(images/img135.jpg);">
				<div class="alignHolder d-flex w-100 align-items-center">
					<div class="align w-100 position-relative">
						<div class="container">
							<h1 class="text-white mb-2">Causes-List</h1>
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
									<li class="breadcrumb-item"><a href="home.html">Home</a></li>
									<li class="breadcrumb-item"><a href="javascript:void(0);">Pages</a></li>
									<li class="breadcrumb-item active" aria-current="page">Causes-List</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-9">
							<div class="pr-lg-5 pr-xl-15 fontAlter causesListWrap">
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img136.jpg);">
									</div>
								...
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img137.jpg);">
									</div>
									<div class="ocuDescripWrap pt-6 pb-8 px-5">
								...
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img138.jpg);">
									</div>
									<div class="ocuDescripWrap pt-6 pb-8 px-5">
										...
										<div class=" progress-bar bg-white position-relative" id="progress-bar">
											<span class="d-block progressBar my-4 mb-7">
												<span class="percentageProgBar" style="width: 62%;">
													<span class="bar">
														<span class="over" data-percent="100%"></span>
													</span>
								...
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img139.jpg);">
									</div>
									<div class="ocuDescripWrap pt-6 pb-8 px-5">
										...
										<div class=" progress-bar bg-white position-relative" id="progress-bar">
											<span class="d-block progressBar my-4 mb-7">
												<span class="percentageProgBar" style="width: 15%;">
													<span class="bar">
														<span class="over" data-percent="100%"></span>
													</span>
								...
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img140.jpg);">
									</div>
									<div class="ocuDescripWrap pt-6 pb-8 px-5">
								...
								<!-- ourCauseColumn -->
								<article class="ourCauseColumn bg-white shadow mb-6 d-lg-flex">
									<div class="imgHolder flex-shrink-0" style="background-image: url(images/img141.jpg);">
									</div>
									<div class="ocuDescripWrap pt-6 pb-8 px-5">
										...
										<div class=" progress-bar bg-white position-relative" id="progress-bar">
											<span class="d-block progressBar my-4 mb-7">
												<span class="percentageProgBar" style="width: 50%;">
													<span class="bar">
														<span class="over" data-percent="100%"></span>
													</span>
							...
							<nav aria-label="Page navigation">
								<ul class="pagination justify-content-center p-0 mt-14 mb-0">
