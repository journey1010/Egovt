				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-12 col-sm-9 col-lg-6 col-xlwd-4 text-center">
							<strong class="header-404 fontAlter d-flex align-items-center justify-content-center">4 <img class="px-3" src="images/ico-stop.png" alt="image description"> 4</strong>
							<h2>Ohh! Page Not Found</h2>
							<p>It looks like nothing was found at this location. Click the button below to return home.</p>
							<form action="#" class="pt-4 mb-11">
								<div class="input-group">
									<input type="text" class="form-control shadow" placeholder="What Looking For">
									<div class="input-group-append">
										<button type="button" class="btn btnTheme d-flex fwMedium text-capitalize position-relative border-0 p-0" data-hover="Search">
											<span class="d-block btnText">Search</span>
										</button>
									</div>
								</div>
							</form>
							<a href="home.html" class="btn btn-dark fwSemiBold position-relative border-0 p-0 minWidthMedium" data-hover="Back to Home">
