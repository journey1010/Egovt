...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
			<header class="pageMainHead d-flex position-relative bgCover w-100 text-white" style="background-image: url(images/img126.jpg);">
				<div class="alignHolder d-flex w-100 align-items-center">
					<div class="align w-100 position-relative">
						<div class="container">
							<h1 class="text-white mb-2">Become A Volunteer</h1>
						...
						<div class="col-12 col-md-6 px-lg-5">
							...
							<div class="extraWrap mb-10 mb-md-0">
								...
								<header class="fzMedium mb-6">
								   <h2 class="fwSemiBold h2vii mb-6">Join with Us! Need your heartful help</h2>
								   <p class="text-lDark mb-6">We want to save lives at some of your favorite concerts, festivals and events. A gift from you will allow us to:</p>
								</header>
								<p>Hackathon interaction design channels crowdsource holy grail backing funding success scrum project growth hacking influencer twitter beta prototype. Crowdfunding user experience Look.</p>
								<!-- imgWarp -->
								<div class="imgWarp my-6 my-md-8 mt-xl-12 mb-xl-10">
									<img src="images/img127.jpg" class="img-fluid" alt="image description">
								</div>
								...
								<form action="#" class="pt-10 px-4 px-sm-7 pb-8 becomeVolunteerForm">
									...
									<div class="form-row">
										...
										<div class="form-group col-12">
											<label class="fLabel fontAlter fwMedium d-block">Name<span class="text-danger fsSmall">*</span></label>
									...
									<div class="form-row">
										<!-- form-group  -->
										<div class="form-group col-12">
											<label class="fLabel fontAlter fwMedium d-block">Email Address<span class="text-danger fsSmall">*</span></label>
									...
									<div class="form-row">
										<!-- form-group  -->
										<div class="form-group col-12">
											<label class="fLabel fontAlter fwMedium d-block">Phone Number<span class="text-danger fsSmall">*</span></label>
									...
									<div class="form-row">
										<!-- form-group  -->
										<div class="form-group col-12">
											<label class="fLabel fontAlter fwMedium d-block">Address<span class="text-danger fsSmall">*</span></label>
											<input type="text" class="form-control">
										</div>
									</div>
									<div class="form-row">
										...
										<div class="form-group col-12 col-xl-6 mt-1 mt-sm-0">
											<label class="fLabel fontAlter fwMedium d-block">City<span class="text-danger fsSmall">*</span></label>
										...
										<div class="form-group col-12 col-xl-6">
											<label class="fLabel fontAlter fwMedium d-block">State/Region<span class="text-danger fsSmall">*</span></label>
											<div class="coolSelectWrapper">
												<!-- coolSelect -->
									...
									<div class="form-row">
										...
										<div class="form-group col-12 mb-0">
											<button type="submit" class="btn btnTheme text-capitalize position-relative border-0 p-0 minWidthMedium btnxLarge w-100" data-hover="Send Inquiry">
			...
			<!-- vibrantAsideBlock  -->
			<aside class="vibrantAsideBlock noFixHeight noOverLay position-relative text-center text-white overflow-hidden d-flex pt-8 pb-4 pb-md-10 pb-lg-15 py-xl-21">
					...
					<div class="container align">
						...
						<div class="row">
							<div class="col-12 col-md-4">
								<!-- gbfColumn  -->
								<article class="gbfColumn gbfcVII bg-white shadow text-center pt-5 pb-7 px-3 px-sm-6 px-md-5 px-lg-9 px-xl-14 mb-6">
									<i class="icnWrap icomoon-ico29 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
									<h3 class="mb-0 fwMedium h3Small position-relative pb-4">We want to help to as many as we can</h3>
								</article>
							</div>
							<div class="col-12 col-md-4">
								<!-- gbfColumn  -->
								<article class="gbfColumn gbfcVII bg-white shadow text-center pt-5 pb-7 px-3 px-sm-6 px-md-5 px-lg-9 px-xl-14 mb-6">
									<i class="icnWrap icomoon-ico30 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
									<h3 class="mb-0 fwMedium h3Small position-relative pb-4">Your support will bring more energy</h3>
								</article>
							</div>
							<div class="col-12 col-md-4">
								<!-- gbfColumn  -->
								<article class="gbfColumn gbfcVII bg-white shadow text-center pt-5 pb-7 px-3 px-sm-6 px-md-5 px-lg-9 px-xl-14 mb-6">
									<i class="icnWrap icomoon-ico31 rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3"><span class="sr-only"></span></i>
									<h3 class="mb-0 fwMedium h3Small position-relative pb-4">We always have believe in team work</h3>
								</article>
							</div>
						</div>
					</div>
				</div>
				<div class="parallaxWindow w-100 position-absolute" data-parallax="scroll" data-image-src="images/img128.jpg"></div>
			</aside>
			<!-- testimonialsBlock -->
			<article class="testimonialsBlock bgLight position-relative pt-12 pb-8 pb-md-10 pb-lg-15 py-xl-21">
				<div class="container">
					<header class="watermarkHeadingHead text-center position-relative mb-7 mb-lg-10" data-watermark="Testimonials">
					...
					<div class="row">
						<div class="col-12 col-md-10 offset-md-1 px-xl-13">
							...
							<div class="quotesSlider">
								<div>
									<!-- clientQuote -->
									<blockquote class="clientQuote fontAlter position-relative pt-25 pt-sm-0 pl-sm-40 pl-lg-50 mb-0">
										<q class="d-block position-relative mb-4 mb-md-6 mb-lg-7 pt-4 pl-8 pl-sm-0">BNI India is India’s largest and most successful business net working organisation. We offer our members the opportunity to share ideas, contacts, and most importantly!</q>
										<cite class="d-block pl-8 pl-sm-0">
											<!-- profilePicWrap -->
											<span class="profilePicWrap position-absolute overflow-hidden rounded-circle">
												<img src="images/img129.png" class="img-fluid w-100 h-100 imgFit rounded-circle" alt="Donald Salvor || Global Initiative">
											</span>
											<span class="eWrap d-block">
												<strong class="d-block fwMedium text-capitalize mb-1">Dr. Kristina Castle</strong>
								...
								<div>
									...
									<blockquote class="clientQuote fontAlter position-relative pt-25 pt-sm-0 pl-sm-40 pl-lg-50 mb-0">
										...
										<cite class="d-block pl-8 pl-sm-0">
											<!-- profilePicWrap -->
											<span class="profilePicWrap position-absolute overflow-hidden rounded-circle">
												<img src="images/img22.jpg" class="img-fluid w-100 h-100 imgFit rounded-circle" alt="Donald Salvor || Global Initiative">
											</span>
											<span class="eWrap d-block">
