...
<body>
	...
	<div id="pageWrapper">
		...
		<main>
			<header class="pageMainHead d-flex position-relative bgCover w-100 text-white" style="background-image: url(images/img50.jpg);">
						...
						<div class="container">
							...
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrWhite rounded-0 border-0 p-0 fontAlter mb-0">
									...
									<li class="breadcrumb-item"><a href="eventsList.html">Event</a></li>
									<li class="breadcrumb-item active" aria-current="page">Organizing City Photography Contest-2022</li>
								</ol>
							</nav>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-12 col-lg-9 mb-6">
							<div class="pr-lg-5 pr-xl-15 bodyFontAlter">
								<header class="dtlItemHeader mt-n1 mb-10">
									<strong class="dtlihTitle d-block">In <a href="javascript:void(0);">Conference</a></strong>
									<h2 class="mb-9">Organizing City Photography Contest-2022</h2>
									<div class="imgHolder">
										<img src="images/img82.jpg" class="img-fluid w-100" alt="image description">
									</div>
									<address class="mb-0 dtlhDress fontAlter">
										<div class="row no-gutters">
											<div class="col-12 col-sm-4 px-4 px-md-7 pt-6 pb-12">
												<strong class="d-block title fwSemiBold mb-2">Date</strong>
												<span class="d-block">
											...
											<div class="col-12 col-sm-4 px-4 px-md-7 pt-6 pb-12">
												<strong class="d-block title fwSemiBold mb-2">Time</strong>
												<span class="d-block">
											...
											<div class="col-12 col-sm-4 px-4 px-md-7 pt-6 pb-12">
												<strong class="d-block title fwSemiBold mb-2">Location</strong>
												<span class="d-block">Mayor Office, Norway city</span>
												<i class="icomoon-locationpin icnWatermark"><span class="sr-only">icon</span></i>
											</div>
										</div>
									</address>
								</header>
								<p class="mb-6">Numbers say it all. Globally, progress in the wind sector continues to be strong with increasing annual installed capacity and growing investment in the sector. In 2015 alone, 63,013 megawatts  of wind power capacity was installed globally an annual market growth of 22 percent. It is continuing its progress towards becoming a mainstream, competitive and reliable power source in both developing and mature markets. In fact, wind is becoming cheap enough in many places in the U.S. </p>
								<p class="mb-6">Yoga is a group of physical, mental, and spiritual practices or disciplines which originated in ancient India. There is a broad variety of Yoga schools, practices, and goals in Hinduism, Buddhism, and Jainism. Among the most well-known types of yoga are Hatha yoga and Raja yoga.</p>
								<aside class="countdownAside d-md-flex align-items-md-center mt-9 mb-8 px-4 pt-5 pb-6">
									<ul class="list-unstyled cdScheduleList fontAlter mb-4 mb-md-0 flex-grow-1 d-flex flex-wrap">
										<li>
											<strong class="title d-block font-weight-normal text-white dataCount">98</strong>
											<strong class="d-block fwMedium">Days</strong>
										</li>
										<li>
											<strong class="title d-block font-weight-normal text-white dataCount">10</strong>
											<strong class="d-block fwMedium">Hours</strong>
										</li>
										<li>
											<strong class="title d-block font-weight-normal text-white dataCount">56</strong>
											<strong class="d-block fwMedium">Minutes</strong>
										</li>
										<li>
											<strong class="title d-block font-weight-normal text-white dataCount">24</strong>
											<strong class="d-block fwMedium">Seconds</strong>
										</li>
									</ul>
									<a href="javascript:void(0);" class="btn btnGaryWhite fwMedium text-capitalize flex-shrink-0 position-relative border-0 p-0 ml-4" data-hover="Participate Now">
										<span class="d-block btnText">Participate Now</span>
									</a>
								</aside>
								<h3 class="h3vvii fwSemiBold mb-4">Makeup Change the World</h3>
								<p class="mb-7">Numbers say it all. Globally, progress in the wind sector continues to be strong with increasing annual installed capacity and growing investment in the sector. In 2015 alone, 63,013 megawatts  of wind power capacity was installed globally an annual market growth of 22 percent. It is continuing its progress towards becoming a mainstream, competitive and reliable power source in both developing and mature markets. In fact, wind is becoming cheap enough in many places in the U.S. </p>
								...
								<h2 class="h2vii fwSemiBold mb-5">Speakers &amp; Chief Guests</h2>
								<div class="row d-block mb-7 mb-lg-9 mb-xl-13">
									<div class="scgSpeakersSlider">
										<div class="col-12">
											<article class="speakerColumn text-center shadow bg-white pt-6 pb-7 px-4 mb-6">
												<div class="imgHolder rounded-circle mb-3">
													<img src="images/img83.jpg" class="img-fluid rounded-circle" alt="image description">
												</div>
												<h3 class="fwMedium mb-1">Anna Roselaw</h3>
												<h4 class="fontBase font-weight-normal">City Council</h4>
											</article>
										</div>
										<div class="col-12">
											<article class="speakerColumn text-center shadow bg-white pt-6 pb-7 px-4 mb-6">
												<div class="imgHolder rounded-circle mb-3">
													<img src="images/img84.jpg" class="img-fluid rounded-circle" alt="image description">
												</div>
												<h3 class="fwMedium mb-1">Robert Davis</h3>
												<h4 class="fontBase font-weight-normal">City Council</h4>
											</article>
										</div>
										<div class="col-12">
											<article class="speakerColumn text-center shadow bg-white pt-6 pb-7 px-4 mb-6">
												<div class="imgHolder rounded-circle mb-3">
													<img src="images/img85.jpg" class="img-fluid rounded-circle" alt="image description">
												</div>
												<h3 class="fwMedium mb-1">San Mangrow</h3>
								...
								<ul class="nav nav-tabs scgTabList fontAlter mb-8" id="scgTabs" role="tablist">
									<li class="nav-item">
									...
									<li class="nav-item">
										<a class="nav-link" id="condet-tab" data-toggle="tab" href="#condet" role="tab" aria-controls="condet" aria-selected="false">Contact Details</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" id="gallery-tab" data-toggle="tab" href="#gallery" role="tab" aria-controls="gallery" aria-selected="false">Gallery</a>
									</li>
								</ul>
								<div class="tab-content scgTabContent mb-10" id="scgTabsContent">
									<div class="tab-pane fade show active" id="location" role="tabpanel" aria-labelledby="location-tab">
										<div class="overflow-hidden">
											<div class="ctMapWrap position-relative w-100">
												<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3117.246590958436!2d-90.29455418438972!3d38.62020787083965!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87d8b57ada367f63%3A0xe3ea4c84d3e6b420!2sC%20%26%20B%20Lift%20Truck%20Service%2C%20Inc.!5e0!3m2!1sen!2s!4v1630908088272!5m2!1sen!2s" width="100%" height="498" allowfullscreen="" loading="lazy"></iframe>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="condet" role="tabpanel" aria-labelledby="condet-tab">
										<div class="overflow-hidden">
									...
									<div class="tab-pane fade" id="gallery" role="tabpanel" aria-labelledby="gallery-tab">
										<div class="overflow-hidden">
											<ul class="list-unstyled d-flex flex-wrap scgGalleryList">
												<li>
													<a href="images/img24.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img24.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
												<li>
													<a href="images/img25.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img25.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
												<li>
													<a href="images/img29.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img29.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
												<li>
													<a href="images/img26.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img26.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
												<li>
													<a href="images/img28.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img28.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
												<li>
													<a href="images/img27.jpg" class="lightbox" data-fancybox="true">
														<img src="images/img27.jpg" class="img-fluid" alt="image description">
													</a>
												</li>
											</ul>
										</div>
								...
								<div class="tagsWrap d-flex flex-wrap align-items-center mb-6">
									<strong class="title d-block flex-shrink-0 fontAlter font-weight-normal mb-2 text-lDark mr-2">Tags:</strong>
									<ul class="list-unstyled tagList fontAlter d-flex flex-wrap mb-0">
										<li>
											<a href="javascript:void(0);" class="current">Event</a>
										</li>
										<li>
											<a href="javascript:void(0);">Entertainemnt</a>
										</li>
										<li>
								...
								<nav class="postNavigatorNav border-0 position-relative mb-2 mb-md-6 mb-lg-10 mb-xl-13 px-10 px-md-14 px-xl-18">
									<a href="javascript:void(0);" class="btnPrev flex-shrink-0 d-flex position-absolute align-items-center justify-content-center" style="background-image: url(images/img02.jpg);">
										<i class="fa-chevron-left" aria-hidden="true"><span class="sr-only">icon</span></i>
									</a>
									<ul class="list-unstyled mb-0 pnnPaginList d-flex fontAlter justify-content-between">
										<li>
											<a class="text-uppercase" href="javascript:void(0);">Previous</a>
											<strong class="h4 d-none d-sm-block fwSemiBold mb-0">
												<a href="javascript:void(0);">Summer Nights at the Library</a>
											</strong>
										</li>
										<li>
											<a class="text-uppercase" href="javascript:void(0);">Next</a>
											<strong class="h4 d-none d-sm-block fwSemiBold mb-0">
												<a href="javascript:void(0);">Urban Renewal Loans Available</a>
											</strong>
										</li>
									</ul>
									<a href="javascript:void(0);" class="btnNext flex-shrink-0 d-flex position-absolute align-items-center justify-content-center" style="background-image: url(images/img01.jpg);">
										<i class="fa fa-chevron-right" aria-hidden="true"><span class="sr-only">icon</span></i>
									</a>
								</nav>
								...
								<hr class="mt-6 mb-7 mb-md-11">
								<h2 class="h2vii fwSemiBold mb-6">Related Events</h2>
								<div class="row mb-4">
									<div class="col-12 col-md-6">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 w-100">
											<div class="imgHolder position-relative">
												<a href="eventSingle.html">
													<img src="images/img63.jpg" class="img-fluid d-block w-100" alt="image description">
												</a>
											...
											<div class="ueDescriptionWrap pt-5 pb-8 px-5">
												...
												<h3 class="h3Small fwMedium mb-3">
													<a href="eventSingle.html">Annual Cycling Race 2020 for the Covid-19 Donation</a>
												</h3>
												<address>
													<ul class="list-unstyled ueScheduleList">
														<li>
												...
												<a href="eventSingle.html" class="btn btnCustomLightOutline bdrWidthAlter btn-sm text-capitalize position-relative border-0 p-0 mt-3 align-top" data-hover="More Details">
									...
									<div class="col-12 col-xl-6">
										<article class="ueEveColumn position-relative shadow bg-white mb-6 w-100">
											<div class="imgHolder position-relative">
												<a href="eventSingle.html">
													<img src="images/img64.jpg" class="img-fluid d-block w-100" alt="image description">
												</a>
												<time class="ueTimeTag position-absolute text-center d-flex bg-white fontAlter fwSemiBold text-lDark text-uppercase" datetime="2011-01-12">
											...
											<div class="ueDescriptionWrap pt-5 pb-8 px-5">
												<strong class="d-block ueCatTitle fwSemiBold text-secondary mb-2">Health &amp; Sports</strong>
												<h3 class="h3Small fwMedium mb-3">
													<a href="eventSingle.html">Celebrating World Fiteness Day at White Corner’20</a>
												</h3>
												<address>
													<ul class="list-unstyled ueScheduleList">
														<li>
						...
						<div class="col-12 col-lg-3 mb-6">
							<div class="ml-lg-n5">
								<aside class="sidebar">
									...
									<section class="widget widgetFeaturEvent mb-6 mb-lg-10">
										<h3 class="fwMedium mb-5">Featured Event</h3>
										<article class="ueEveColumn position-relative shadow bg-white w-100">
											<div class="imgHolder position-relative">
												<a href="eventSingle.html">
													<img src="images/img10.jpg" class="img-fluid d-block w-100" alt="image description">
												</a>
												<time class="ueTimeTag position-absolute text-center d-flex bg-white fontAlter fwSemiBold text-lDark text-uppercase" datetime="2011-01-12">
											...
											<div class="ueDescriptionWrap pt-5 pb-8 px-5">
												...
												<h3 class="h3Small fwMedium mb-3">
													<a href="eventSingle.html">Cultural Festival &amp; Concert at Domanion Valer</a>
												</h3>
												<address>
													<ul class="list-unstyled ueScheduleList pl-0">
														<li>
															<i class="icomoon-clock icn position-absolute"><span class="sr-only">icon</span></i>
															1:00pm - 5:00pm
														</li>
									...
									<nav class="widget widgetUpcoming mb-6 mb-lg-10">
										<h3 class="fwMedium mb-5">Upcoming Events</h3>
										<ul class="list-unstyled pl-0 mb-7">
											<li>
												<div class="imgHolder flex-shrink-0 mr-4 mt-1">
													<img src="images/img73.jpg" class="img-fluid" alt="image description">
												</div>
												<div class="descrWrap">
													<h4 class="fwMedium mb-1">
														<a href="eventSingle.html">Annual Cycling Race 2020 for the Covid-19</a>
													</h4>
													<time datetime="2011-01-12" class="d-block">Oct 16, 2020 <br>@ 1:00 pm - 6:00 pm</time>
												</div>
											</li>
											<li>
												<div class="imgHolder flex-shrink-0 mr-4 mt-1">
													<img src="images/img74.jpg" class="img-fluid" alt="image description">
												</div>
												<div class="descrWrap">
													<h4 class="fwMedium mb-1">
														<a href="eventSingle.html">Celebrating World Fiteness Day at White Corner’20</a>
													</h4>
													<time datetime="2011-01-12" class="d-block">Nov 16, 2020 <br>@ 9:00 am - 6:00 pm</time>
												</div>
											</li>
											<li>
												<div class="imgHolder flex-shrink-0 mr-4 mt-1">
													<img src="images/img75.jpg" class="img-fluid" alt="image description">
												</div>
												<div class="descrWrap">
													<h4 class="fwMedium mb-1">
														<a href="eventSingle.html">City Innovation and Technology Committee&hellip;</a>
													</h4>
													<time datetime="2011-01-12" class="d-block">Dec 16, 2020  <br>@ 8:00 am - 5:00 pm</time>
												</div>
											</li>
										</ul>
										<a href="javascript:void(0);" class="readMoreLink fontAlter fwMedium">View All Events <i class="fa fa-chevron-right btnRmlIcn" aria-hidden="true"><span class="sr-only">icon</span></i></a>
									</nav>
									...
									<section class="widget widgetTags mb-6 mb-lg-10">
										...
										<ul class="list-unstyled pl-0 d-flex flex-wrap fontAlter">
											...
											<li>
												<a href="javascript:void(0);">Smart City</a>
											</li>
											<li>
