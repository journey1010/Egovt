...
jQuery(document).ready(function(){
	...
	function initSlickCarousel() {
		jQuery('.ibSlider').slick({
			...
			dots: false,
			arrows: true,
			prevArrow: '<a href="#" class="slickPrev ssArrowVi rounded-circle d-flex align-items-center justify-content-center fa fa-chevron-left position-absolute"><span class="sr-only">prev</span></a>',
			nextArrow: '<a href="#" class="slickNext ssArrowVi rounded-circle d-flex align-items-center justify-content-center fa fa-chevron-right position-absolute"><span class="sr-only">next</span></a>',
			autoplay: true,
			fade: true,
			speed: 1300,
			adaptiveHeight: true,
		...
		jQuery('.arddColumnSlider').slick({
			...
			slidesToScroll: 3,
			arrows: true,
			prevArrow: '<a href="#" class="slickPrev ssArrowVii rounded-circle d-flex align-items-center justify-content-center fa-chevron-left position-absolute"><span class="sr-only">prev</span></a>',
			nextArrow: '<a href="#" class="slickNext ssArrowVii rounded-circle d-flex align-items-center justify-content-center fa fa-chevron-right position-absolute"><span class="sr-only">next</span></a>',
			dots: true,
			dotsClass: 'dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-4 mt-lg-8',
			responsive: [
				{
